...
class Cart with ChangeNotifier{
  ...
  void addItem(String productId, double  price , String title){
    if(_items.containsKey(productId)){
      _items.update(productId, (value) => CartItem(id: DateTime.now().toString(), title: title, quantity: value.quantity+1, price: price));
    }
    else{
  ...
  void removeSingleItem(String productId)
  {
      ...
      var quantity =items[productId]?.quantity;
      if(quantity! > 1) {
